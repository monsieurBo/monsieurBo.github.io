...
// displays lightbox
	...
	// // register target galleryItem
	// const newGalleryItem = event.target;
	// const galleryItemParent = newGalleryItem.parentElement;

	// // replace contents of lightbox with target(current) content
	// lBoxImage.innerHTML = galleryItemParent.innerHTML;
